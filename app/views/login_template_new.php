    ...
    <div class="card">
        <div class="card-block">
            ...
            <h3 class="text-center mt-0 m-b-15">
                <a href="index.html" class="logo logo-admin"><img src="<?php echo __HOST__; ?>/assets/images/logo.png" height="54" alt="logo"></a>
            </h3>
            ...
            <div class="p-3">
                <form class="form-horizontal m-t-20 m-t-md" action="" method="post">
                    ...
                    <div class="form-group m-t-10 mb-0 row spec-log-cl">
                        <div class="col-sm-5 m-t-20" style="text-align: left; font-size: 16px; padding-left: 0px; padding-right: 0px;">
                            <a href="<?php echo __HOST__; ?>/registration" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a>
                        </div>
                    </div>
                </form>
                <?php extract($data); ?>
